...
ArrayList<Controles> lista2=new ArrayList<Controles>(); 
    ...
    private void initComponents() {
        ...
        cerrar.setFont(new java.awt.Font("Calibri Light", 2, 18)); // NOI18N
        ...
        cerrar.setBounds(450, 10, 30, 23);

        scroll.setBackground(new java.awt.Color(0, 0, 0));
        scroll.setForeground(new java.awt.Color(255, 255, 255));

        historial.setColumns(20);
        historial.setForeground(new java.awt.Color(204, 0, 0));
        historial.setRows(5);
        historial.setCaretColor(new java.awt.Color(204, 0, 0));
        historial.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        historial.setSelectedTextColor(new java.awt.Color(204, 0, 0));
        historial.setSelectionColor(new java.awt.Color(204, 0, 0));
